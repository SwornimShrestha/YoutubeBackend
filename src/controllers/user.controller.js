...
const generateAccessAndRefereshTokens = async (userId) => {
  try {
    ...
    user.refreshToken = refreshToken; //saving in database
    user.save({ validateBeforeSave: false }); //other mongooose will kickin if we save refereshtoken so use this
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // show if array have come or not
  if (
    req.files &&
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //without this user can easily modify front frontend
